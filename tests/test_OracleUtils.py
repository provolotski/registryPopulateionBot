...
#
from Databases import OracleUtils


def test_env():
    print(os.environ['OracleHost'])
    print(os.environ['OraclePort'])
    print(os.environ['OracleSid'])
    print(os.environ['OracleUser'])
    print(os.environ['OraclePassword'])
